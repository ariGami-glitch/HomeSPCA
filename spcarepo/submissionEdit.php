...
$submission = new Submission(null, null, null, null, null, null, null, false, null);
...
<html>
	...
	<div id="container">
		...
		if ($dup)
		    ...
		    $newsubmission = new Submission($email, $first_name, $last_name, $pet_type, $description, $pet_name, "", "");
